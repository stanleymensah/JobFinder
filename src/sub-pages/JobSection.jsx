  ...
  return (
    <div className="job-section bg-sky-100 p-5">
      <div className="top flex justify-between items-center mb-4">
        <h1 className="text-xl md:text-2xl lg:text-3xl font-medium">Recommended jobs</h1>
      ...
      <div className="bottom flex flex-col gap-4 pt-3 md:flex-row">
        ...
        <div className="right flex justify-center w-full  overflow-y-auto h-[600px] p-2 md:w-4/5" ref={scrollRef}>
          {loading && (
